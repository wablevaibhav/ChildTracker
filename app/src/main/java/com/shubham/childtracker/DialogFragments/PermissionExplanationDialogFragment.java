...
public class PermissionExplanationDialogFragment extends DialogFragment {
	...
	public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
		TextView txtPermissionBody = view.findViewById(R.id.txtPermissionBody);
		...
		final int requestCode = Objects.requireNonNull(bundle).getInt(Constant.PERMISSION_REQUEST_CODE);
		...
		Button btnOkPermission = view.findViewById(R.id.btnOkPermission);
		btnOkPermission.setOnClickListener(v -> {
			onPermissionExplanationListener.onOk(requestCode);
			dismiss();
		});

		Button btnCancelPermission = view.findViewById(R.id.btnCancelPermission);
		btnCancelPermission.setOnClickListener(v -> {
