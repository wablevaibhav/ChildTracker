...
public class SMSPermissionsFragment extends Fragment implements CompoundButton.OnCheckedChangeListener, OnPermissionExplanationListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnPermissionsSmsNext.setOnClickListener(v -> {
        ...
        btnPermissionsSmsPrev.setOnClickListener(v -> onFragmentChangeListener.onFragmentChange(Constant.PERMISSIONS_MAIN_FRAGMENT));
