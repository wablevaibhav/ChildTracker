...
public class PhoneCallsPermissionsFragment extends Fragment implements CompoundButton.OnCheckedChangeListener, OnPermissionExplanationListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnPermissionsPhoneCallsNext.setOnClickListener(v -> {
        ...
        btnPermissionsPhoneCallsPrev.setOnClickListener(v -> onFragmentChangeListener.onFragmentChange(Constant.PERMISSIONS_SMS_FRAGMENT));
